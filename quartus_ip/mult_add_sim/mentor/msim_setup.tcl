...
# ----------------------------------------
# If mult_add is one of several IP cores in your
...
# ----------------------------------------
# ACDS 20.1 711 win32 2023.04.19.12:38:22
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/mult_add.v"
}
