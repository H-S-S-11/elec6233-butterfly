...
iverilog -g2012 -o butterfly_datapath_tb.vvp butterfly_datapath_tb.v butterfly.v ../quartus_ip/mult_add.v ../quartus_ip/mult_add/mult_add_0002.v C:\intelFPGA_lite\20.1\quartus\libraries\megafunctions\altera_mult_add_rtl.v
